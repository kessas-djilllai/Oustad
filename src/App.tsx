    ...
    return (
      <div className="space-y-4 md:space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
          <div className="col-span-1 md:col-span-2 glass rounded-3xl md:rounded-[2rem] p-4 md:p-6 min-h-[120px] md:min-h-[160px] flex flex-col justify-center gap-2 md:gap-4">
             <div className="h-6 md:h-8 bg-slate-200/60 rounded-xl w-2/3 md:w-1/2 animate-pulse" />
             <div className="h-10 md:h-14 bg-slate-200/60 rounded-xl md:rounded-2xl w-full animate-pulse mt-1 md:mt-2" />
          </div>

          <div className="col-span-1 glass rounded-3xl md:rounded-[2rem] p-4 md:p-6 min-h-[120px] md:min-h-[160px] flex flex-row md:flex-col items-center md:items-start justify-between md:justify-center gap-3 md:gap-4">
            <div className="flex items-center gap-3 md:gap-0 md:flex-col md:items-start w-full">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl md:rounded-2xl bg-slate-200/60 animate-pulse shrink-0 md:mb-4" />
              <div className="space-y-1.5 md:space-y-2 w-full">
                 <div className="h-3 md:h-4 bg-slate-200/60 rounded-md w-1/2 animate-pulse" />
                 <div className="h-4 md:h-6 bg-slate-200/60 rounded-md w-3/4 animate-pulse" />
              </div>
            </div>
            <div className="w-16 h-6 md:w-20 md:h-8 bg-slate-200/60 rounded-lg animate-pulse shrink-0" />
          </div>
        </div>

        <div>
          <div className="flex justify-between items-center mb-3 md:mb-4">
             <div className="h-5 md:h-6 bg-slate-200/60 rounded-lg w-1/3 md:w-1/4 animate-pulse" />
             <div className="h-5 md:h-6 bg-slate-200/60 rounded-lg w-16 md:w-24 animate-pulse" />
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
            {[1, 2, 3].map((i) => (
               <div key={i} className="glass rounded-3xl md:rounded-[2rem] p-3 md:p-6 min-h-[140px] md:min-h-[180px] flex flex-col justify-between">
                  <div className="flex justify-between items-start mb-3 md:mb-6">
                    <div className="w-8 h-8 md:w-12 md:h-12 rounded-xl md:rounded-2xl bg-slate-200/60 animate-pulse" />
                    <div className="w-10 h-4 md:w-16 md:h-6 bg-slate-200/60 rounded-md md:rounded-lg animate-pulse" />
                  </div>
                  <div className="space-y-2 md:space-y-3 w-full">
                    <div className="h-4 md:h-5 bg-slate-200/60 rounded-md w-3/4 animate-pulse" />
                    <div className="flex justify-between">
                      <div className="h-2 md:h-3 bg-slate-200/60 rounded-md w-1/3 animate-pulse" />
                      <div className="h-2 md:h-3 bg-slate-200/60 rounded-md w-1/6 animate-pulse" />
                    </div>
                    <div className="h-1 md:h-1.5 bg-slate-200/60 rounded-full w-full animate-pulse" />
                  </div>
               </div>
            ))}
          </div>
